...
# =============================================================================
import pandas as pd
data = pd.DataFrame(pd.read_csv('Dataset_14.csv'))
...
# 1. 데이터셋 결합 2. 요일 3. 1분기
alcol = list[['prod_nm','alcohol']]
q2 = pos.copy()
...
q2_merge = pd.merge(q2, list1, left_on='itemDescription',right_on='prod_nm',how='left')
...
q2_tab = pd.pivot_table(q2_2, index = 'Date', columns = 'week', values='alcohol', aggfunc='sum')


from scipy.stats import ttest_ind


ttest_ind(q2_tab[1].dropna(), q2_tab[0].dropna())
...
q3_tab = pd.pivot_table(data = q3, index = ['Date', 'day'], values = 'itemDescription', aggfunc='count').reset_index()
